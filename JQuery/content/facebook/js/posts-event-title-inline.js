...
function formatDate(startDate) {
	...
	dateStr += ' <span style="white-space:nowrap">at ' + showTheHours(startDate.getHours()) + ':' + showZeroFilled(startDate.getMinutes()) + ' ' + showAmPm(startDate) + '</span>';
	return dateStr;
}
...
$.ajaxSetup({async:false});
    ...
    */
	var url = "https://graph.facebook.com/" + fbFolder + "/posts?access_token=" + token + "&limit=" + fbLimit + "&callback=?";
