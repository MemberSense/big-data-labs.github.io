        ...
        function loadList($widgetContainer) {
            ...
            if (settings.updateBrowserHash == true) {
                if (typeof ($.fn.hashchange) == "undefined") {
                    ...
                    var hashchangeUrl = scriptDomain + '/base/vendor/js/jquery.ba-hashchange.min.js';
            ...
            */
            ...
            function initiateSlideshow($slideshowContainer) {
                ...
                $("#smartAngularCarouselHolder").slick({
                  // dots: true,
                  infinite: true,
                  speed: 500,
                  fade: true,
                ...
                for(var i = 0; i < datalen; i++) {
                    ...
                    html[++j] = '<div class="slide-text active" style="display: block;">';
                    html[++j] = '<div class="buttons"><a href="javascript:void(0);" class="btn-icon expander"><i class="fa fa-plus"></i>More</a></div>';
                    if(typeof data[i].title !== 'undefined' && data[i].title != '') {
                        html[++j] = '<div class="slide-title">'+data[i].title+'</div>';
                    }
                    if(typeof data[i].slide_summary !== 'undefined' && data[i].slide_summary != '') {
                        html[++j] = '<span class="slide-summary">'+data[i].slide_summary+' </span>';
                    }
                    html[++j] = '<div class="fullDetailLinks" style="margin-left:0px">';
                    if(typeof data[i].venue !== 'undefined' && typeof data[i].venue.longitude !== 'undefined' && typeof data[i].venue.latitude !== 'undefined' && typeof data[i].venue !== null && typeof data[i].venue.longitude !== null && typeof data[i].venue.latitude !== null) {
                        html[++j] = '<a style="font-weight: bold;" href="javascript(void);" class="gmapDirectionLink" ng-click="loadGmapDirection(this, \''+data[i].venue.latitude+'\', \''+data[i].venue.longitude+'\')" data-location=\'{"lat":"'+data[i].venue.latitude+'", "lang":"'+data[i].venue.longitude+'"}\' >Directions</a>';
                    }
                    html[++j] = '<a href="'+data[i].htmlLink +'" data-id="'+data[i].id+'" target="_blank">Page</a>';
                    if(typeof data[i].itemFeed.detailsUrl !== 'undefined' && data[i].itemFeed.detailsUrl != null) {
                        html[++j] = '<a href="" data-id="'+data[i].id+'" class="detailsLink">Details</a> ';
                    }
                    html[++j] = '<span>'+(i + 1)+' of '+datalen+'</span>'
                    html[++j] = '</div>';
    
                    html[++j] = '<div class="detailsInfo"></div>';
                    html[++j] = '</div>';
                    html[++j] = '<img data-lazy="'+data[i].host+data[i].images[0].large +'" style="background-size:cover;width: 100%;height: 100%;"/>';
                    html[++j] = '</div>';
                    // console.log(html.join(' ')+"---------" + i);
                    $("#smartAngularCarouselHolder").slick('slickAdd',html.join(''));
                    html.length = 0;
                ...
                /*
                carouselData = data;
                $("#smartAngularCarouselHolder").html("<div style=\"height:600px;\" class=\"angularCompile slideshowContainer\" id=\"carousel-ctrl\" ng-controller=\"AngularCarouselCtrl\"><div class=\"pauseResume\" style=\"display: block;\"><div ng-click=\"pauseSlide();\" class=\"pause\"></div><div class=\"resume\" ng-click=\"playSlide();\" style=\"display: none;\"></div></div></div>");
                compileAngularHtml();
