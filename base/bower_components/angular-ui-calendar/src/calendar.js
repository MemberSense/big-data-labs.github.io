    ...
    return {
      ...
      link: function(scope, elm, attrs, controller) {
        ...
        eventsWatcher.onAdded = function(event) {
          // CUSTOM
          // Was: scope.calendar.fullCalendar('renderEvent', event);
          // the reason for change is, when advancing the calendar prev/next 
          // the events are removed (not preserved) from the calendar.
          // this bug is not from the fullcalendar instead it is in the angular-ui-calendar.
